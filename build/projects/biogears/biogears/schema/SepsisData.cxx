  ...
  namespace tatrc
  {
    namespace physiology
    {
      namespace datamodel
      {
        ...
        const SepsisData::Severity_type& SepsisData::
        Severity () const
        {
          return this->Severity_.get ();
        }

        SepsisData::Severity_type& SepsisData::
        Severity ()
        {
          return this->Severity_.get ();
        }
        ...
        const SepsisData::Compartment_type& SepsisData::
        Compartment () const
        {
          return this->Compartment_.get ();
        }

        SepsisData::Compartment_type& SepsisData::
        Compartment ()
        {
          return this->Compartment_.get ();
        }
  ...
  namespace tatrc
  {
    namespace physiology
    {
      namespace datamodel
      {
        ...
        SepsisData::
        SepsisData (const Severity_type& Severity,
        ...
        SepsisData::
        SepsisData (::std::unique_ptr< Severity_type > Severity,
                    const Compartment_type& Compartment)
        : ::mil::tatrc::physiology::datamodel::PatientActionData (),
        ...
        SepsisData::
        SepsisData (const ::xercesc::DOMElement& e,
                    ::xml_schema::flags f,
                    ::xml_schema::container* c)
        ...
        {
          return new class SepsisData (*this, f, c);
        }

        SepsisData& SepsisData::
        operator= (const SepsisData& x)
        {
          if (this != &x)
          {
        ...
        static
        const ::xsd::cxx::tree::type_factory_initializer< 0, char, SepsisData >
        _xsd_SepsisData_type_factory_init (
          "SepsisData",
          "uri:/mil/tatrc/physiology/datamodel");
      }
    }
...
namespace mil
{
  namespace tatrc
  {
    namespace physiology
    {
      ...
      {
        ::std::ostream&
        operator<< (::std::ostream& o, const SepsisData& i)
        {
        ...
        static
        const ::xsd::cxx::tree::std_ostream_initializer< 0, char, SepsisData >
        _xsd_SepsisData_std_ostream_init;
      }
    }
  }
}
...
namespace mil
{
  namespace tatrc
  {
    namespace physiology
    {
      ...
      {
        void
        operator<< (::xercesc::DOMElement& e, const SepsisData& i)
        {
          ...
          //
          {
            ...
            const SepsisData::Severity_type& x (i.Severity ());
            if (typeid (SepsisData::Severity_type) == typeid (x))
            {
        ...
        static
        const ::xsd::cxx::tree::type_serializer_initializer< 0, char, SepsisData >
        _xsd_SepsisData_type_serializer_init (
          "SepsisData",
          "uri:/mil/tatrc/physiology/datamodel");
      }
    }
