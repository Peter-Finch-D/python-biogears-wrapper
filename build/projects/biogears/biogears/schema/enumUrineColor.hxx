...
/**
 * @file
 * @brief Generated from enumUrineColor.xsd.
 */

#ifndef ENUM_URINE_COLOR_HXX
#define ENUM_URINE_COLOR_HXX
    ...
    namespace physiology
    {
      ...
      namespace datamodel
      {
        ...
        class BIOGEARS_CDM_API enumUrineColor: public ::xml_schema::string
        {
          ...
          public:
          static const char* const _xsd_enumUrineColor_literals_[3];
          static const value _xsd_enumUrineColor_indexes_[3];
