...
/**
 * @file
 * @brief Generated from SepsisData.xsd.
 */

#ifndef SEPSIS_DATA_HXX
#define SEPSIS_DATA_HXX
...
namespace mil
{
  namespace tatrc
  {
    namespace physiology
    {
      ...
      {
        /**
         * @brief Class corresponding to the %SepsisData schema type.
         *
         * @nosubgrouping
         */
        class BIOGEARS_CDM_API SepsisData: public ::mil::tatrc::physiology::datamodel::PatientActionData
        {
          public:
          /**
           * @name Severity
           ...
           */
          SepsisData (const Severity_type&,
                      const Compartment_type&);
           ...
           */
          SepsisData (::std::unique_ptr< Severity_type >,
                      const Compartment_type&);
  ...
  namespace tatrc
  {
    namespace physiology
    {
      namespace datamodel
      {
        BIOGEARS_CDM_API
        ::std::ostream&
        operator<< (::std::ostream&, const SepsisData&);
      }
    }
  }
}
  ...
  namespace tatrc
  {
    namespace physiology
    {
      namespace datamodel
      {
        BIOGEARS_CDM_API
        void
        operator<< (::xercesc::DOMElement&, const SepsisData&);
      }
    }
  }
}
